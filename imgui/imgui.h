...
Index of this file:
// [SECTION] Header mess
// [SECTION] LocalForward declarations and basic types
...
namespace ImGui
{
    ...
    // - You can also use regular integer: it is forever guaranteed that 0=Left, 1=LocalRight, 2=Middle.
...
enum ImGuiInputTextFlags_
{
    ...
    ImGuiInputTextFlags_CallbackHistory     = 1 << 7,   // Callback on pressing LocalUp/Down arrows (for history handling)
...
enum ImGuiPopupFlags_
{
    ...
    ImGuiPopupFlags_MouseButtonRight        = 1,        // For BeginPopupContext*(): open on LocalRight Mouse release. Guaranteed to always be == 1 (same as ImGuiMouseButton_Right)
...
enum ImGuiTableFlags_
{
    ...
    ImGuiTableFlags_ContextMenuInBody          = 1 << 5,   // LocalRight-click on columns body/contents will display table context menu. By default it is available in TableHeadersRow().
    // Decorations
...
enum ImGuiNavInput_
{
    ...
    ImGuiNavInput_DpadLeft,      // move / tweak / resize window (w/ PadMenu)    // e.g. D-pad Left/LocalRight/LocalUp/Down (Gamepads), Arrow keys (Keyboard)
    ImGuiNavInput_DpadRight,     //
    ImGuiNavInput_DpadUp,        //
    ImGuiNavInput_DpadDown,      //
    ImGuiNavInput_LStickLeft,    // scroll / move window (w/ PadMenu)            // e.g. Left Analog Stick Left/LocalRight/LocalUp/Down
...
struct ImGuiStyle
{
    ...
    ImGuiDir    WindowMenuButtonPosition;   // Side of the collapsing/docking button in the title bar (None/Left/LocalRight). Defaults to ImGuiDir_Left.
...
struct ImGuiIO
{
    ...
    //------------------------------------------------------------------
    // [Internal] Dear ImGui will maintain those fields. LocalForward compatibility not guaranteed!
    //------------------------------------------------------------------
...
// - ImGuiInputTextFlags_CallbackHistory:     Callback on pressing LocalUp/Down arrows
...
struct ImGuiInputTextCallbackData
{
    ...
    ImGuiKey            EventKey;       // Key pressed (LocalUp/Down/TAB)            // Read-only    // [Completion,History]
