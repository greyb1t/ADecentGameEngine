...
#include "Engine/GraphManager/BlueprintUtilities/Include/ax/Math2D.h"
#include "Engine/GraphManager/BlueprintUtilities/Include/ax/Drawing.h"
#include "Engine/GraphManager/BlueprintUtilities/Include/Interop.h"
    ...
    else
    {
        ...
        if (type == IconType::Square)
        {
            if (filled)
            {
                ...
                drawList->AddRectFilled(p0, p1, color, 0, /*15 + extra_segments*/ ImDrawFlags_RoundCornersAll);
            }
            else
            {
                const auto r = 0.5f * rect.w / 2.0f - 0.5f;
                ...
                drawList->AddRect(p0, p1, color, 0, /*15 + extra_segments*/ ImDrawFlags_RoundCornersAll, 2.0f * outline_scale);
            }
        }
