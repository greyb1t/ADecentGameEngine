...
namespace Engine
{
class JsonDeserializerReflector : public Reflector
{
public:
	JsonDeserializerReflector(const nlohmann::json* aJson, const bool aLoadResourcesNow = false);
...
private:
	const nlohmann::json* myJson = nullptr;
	bool myLoadResourcesNow = false;
};
}