...
namespace MyGame {
    namespace Sample {
        ...
        private:
            MyGame::Sample::Vec4f position_;
            MyGame::Sample::Vec4f color_;
            MyGame::Sample::Vec4f normal_;
            MyGame::Sample::Vec4f tangent_;
            MyGame::Sample::Vec4f binormal_;
            MyGame::Sample::Vec4f bones_;
            MyGame::Sample::Vec4f weights_;
            MyGame::Sample::Vec2f uvs_;
        ...
        public:
            ...
            DefaultVertex(const MyGame::Sample::Vec4f & _position, const MyGame::Sample::Vec4f & _color, const MyGame::Sample::Vec4f & _normal, const MyGame::Sample::Vec4f & _tangent, const MyGame::Sample::Vec4f & _binormal, const MyGame::Sample::Vec4f & _bones, const MyGame::Sample::Vec4f & _weights, const MyGame::Sample::Vec2f & _uvs)
                : position_(_position),
                color_(_color),
                normal_(_normal),
                tangent_(_tangent),
            ...
            const MyGame::Sample::Vec4f& position() const {
                return position_;
            }
            const MyGame::Sample::Vec4f& color() const {
                return color_;
            }
            const MyGame::Sample::Vec4f& normal() const {
                return normal_;
            }
            const MyGame::Sample::Vec4f& tangent() const {
                return tangent_;
            }
            const MyGame::Sample::Vec4f& binormal() const {
                return binormal_;
            }
            const MyGame::Sample::Vec4f& bones() const {
                return bones_;
            }
            const MyGame::Sample::Vec4f& weights() const {
                return weights_;
            }
            const MyGame::Sample::Vec2f& uvs() const {
                return uvs_;
            }
        };
        ...
        private:
            MyGame::Sample::Vec3f position_;
            MyGame::Sample::Quatf rotation_;
            MyGame::Sample::Vec3f scale_;
        ...
        public:
            ...
            NodeData(const MyGame::Sample::Vec3f & _position, const MyGame::Sample::Quatf & _rotation, const MyGame::Sample::Vec3f & _scale, int32_t _parent_node_index)
                : position_(_position),
                rotation_(_rotation),
                scale_(_scale),
                parent_node_index_(flatbuffers::EndianScalar(_parent_node_index)) {
            }
            const MyGame::Sample::Vec3f& position() const {
                return position_;
            }
            const MyGame::Sample::Quatf& rotation() const {
                return rotation_;
            }
            const MyGame::Sample::Vec3f& scale() const {
                return scale_;
            }
        ...
        struct Node FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
            ...
            const MyGame::Sample::NodeData* data() const {
                return GetStruct<const MyGame::Sample::NodeData*>(VT_DATA);
            }
            bool Verify(flatbuffers::Verifier& verifier) const {
                return VerifyTableStart(verifier) &&
                    ...
                    VerifyField<MyGame::Sample::NodeData>(verifier, VT_DATA) &&
                    verifier.EndTable();
            }
        };
        ...
        struct NodeBuilder {
            ...
            void add_data(const MyGame::Sample::NodeData* data) {
        ...
        inline flatbuffers::Offset<Node> CreateNode(
            ...
            const MyGame::Sample::NodeData* data = 0) {
        ...
        inline flatbuffers::Offset<Node> CreateNodeDirect(
            ...
            return MyGame::Sample::CreateNode(
                _fbb,
                name__,
                mesh_indices__,
                children_indices__,
        ...
        struct Mesh FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
            ...
            const MyGame::Sample::Vec3f* local_position() const {
                return GetStruct<const MyGame::Sample::Vec3f*>(VT_LOCAL_POSITION);
            }
            const MyGame::Sample::Quatf* local_rotation() const {
                return GetStruct<const MyGame::Sample::Quatf*>(VT_LOCAL_ROTATION);
            }
            const MyGame::Sample::Vec3f* local_scale() const {
                return GetStruct<const MyGame::Sample::Vec3f*>(VT_LOCAL_SCALE);
            }
            bool Verify(flatbuffers::Verifier& verifier) const {
                return VerifyTableStart(verifier) &&
                    ...
                    VerifyField<MyGame::Sample::Vec3f>(verifier, VT_LOCAL_POSITION) &&
                    VerifyField<MyGame::Sample::Quatf>(verifier, VT_LOCAL_ROTATION) &&
                    VerifyField<MyGame::Sample::Vec3f>(verifier, VT_LOCAL_SCALE) &&
                    verifier.EndTable();
            }
        };
        ...
        struct MeshBuilder {
            ...
            void add_local_position(const MyGame::Sample::Vec3f* local_position) {
                fbb_.AddStruct(Mesh::VT_LOCAL_POSITION, local_position);
            }
            void add_local_rotation(const MyGame::Sample::Quatf* local_rotation) {
                fbb_.AddStruct(Mesh::VT_LOCAL_ROTATION, local_rotation);
            }
            void add_local_scale(const MyGame::Sample::Vec3f* local_scale) {
        ...
        inline flatbuffers::Offset<Mesh> CreateMesh(
            ...
            const MyGame::Sample::Vec3f* local_position = 0,
            const MyGame::Sample::Quatf* local_rotation = 0,
            const MyGame::Sample::Vec3f* local_scale = 0) {
        ...
        inline flatbuffers::Offset<Mesh> CreateMeshDirect(
            ...
            return MyGame::Sample::CreateMesh(
                _fbb,
                meshname__,
        ...
        inline flatbuffers::Offset<BoneToName> CreateBoneToNameDirect(
            ...
            int32_t index = 0) {
            auto name__ = name ? _fbb.CreateString(name) : 0;
            return MyGame::Sample::CreateBoneToName(
                _fbb,
                name__,
                index);
        }
        ...
        struct Model FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
            ...
            const MyGame::Sample::Mat4f* global_inverse_transform() const {
                return GetStruct<const MyGame::Sample::Mat4f*>(VT_GLOBAL_INVERSE_TRANSFORM);
            }
            int16_t bones_count() const {
                return GetField<int16_t>(VT_BONES_COUNT, 0);
            }
            const MyGame::Sample::Vec3f* bounding_sphere_center() const {
                return GetStruct<const MyGame::Sample::Vec3f*>(VT_BOUNDING_SPHERE_CENTER);
            }
            ...
            const flatbuffers::Vector<const MyGame::Sample::DefaultVertex*>* vertices() const {
                return GetPointer<const flatbuffers::Vector<const MyGame::Sample::DefaultVertex*>*>(VT_VERTICES);
            }
            int32_t indices_count() const {
                return GetField<int32_t>(VT_INDICES_COUNT, 0);
            }
            ...
            const flatbuffers::Vector<flatbuffers::Offset<MyGame::Sample::Mesh>>* meshes() const {
                return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<MyGame::Sample::Mesh>>*>(VT_MESHES);
            }
            int32_t bone_offset_count() const {
                return GetField<int32_t>(VT_BONE_OFFSET_COUNT, 0);
            }
            const flatbuffers::Vector<const MyGame::Sample::Mat4f*>* bone_offsets() const {
                return GetPointer<const flatbuffers::Vector<const MyGame::Sample::Mat4f*>*>(VT_BONE_OFFSETS);
            }
            int32_t bone_to_name_count() const {
                return GetField<int32_t>(VT_BONE_TO_NAME_COUNT, 0);
            }
            const flatbuffers::Vector<flatbuffers::Offset<MyGame::Sample::BoneToName>>* bone_to_names() const {
                return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<MyGame::Sample::BoneToName>>*>(VT_BONE_TO_NAMES);
            }
            const flatbuffers::Vector<flatbuffers::Offset<MyGame::Sample::Node>>* nodes() const {
                return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<MyGame::Sample::Node>>*>(VT_NODES);
            }
            bool Verify(flatbuffers::Verifier& verifier) const {
                return VerifyTableStart(verifier) &&
                    VerifyField<MyGame::Sample::Mat4f>(verifier, VT_GLOBAL_INVERSE_TRANSFORM) &&
                    VerifyField<int16_t>(verifier, VT_BONES_COUNT) &&
                    VerifyField<MyGame::Sample::Vec3f>(verifier, VT_BOUNDING_SPHERE_CENTER) &&
        ...
        struct ModelBuilder {
            ...
            flatbuffers::FlatBufferBuilder& fbb_;
            flatbuffers::uoffset_t start_;
            void add_global_inverse_transform(const MyGame::Sample::Mat4f* global_inverse_transform) {
            ...
            void add_bounding_sphere_center(const MyGame::Sample::Vec3f* bounding_sphere_center) {
            ...
            void add_vertices(flatbuffers::Offset<flatbuffers::Vector<const MyGame::Sample::DefaultVertex*>> vertices) {
            ...
            void add_meshes(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<MyGame::Sample::Mesh>>> meshes) {
            ...
            void add_bone_offsets(flatbuffers::Offset<flatbuffers::Vector<const MyGame::Sample::Mat4f*>> bone_offsets) {
            ...
            void add_bone_to_names(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<MyGame::Sample::BoneToName>>> bone_to_names) {
                fbb_.AddOffset(Model::VT_BONE_TO_NAMES, bone_to_names);
            }
            void add_nodes(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<MyGame::Sample::Node>>> nodes) {
        ...
        inline flatbuffers::Offset<Model> CreateModel(
            flatbuffers::FlatBufferBuilder& _fbb,
            const MyGame::Sample::Mat4f* global_inverse_transform = 0,
            int16_t bones_count = 0,
            const MyGame::Sample::Vec3f* bounding_sphere_center = 0,
            float bounding_sphere_radius = 0.0f,
            int32_t vertex_count = 0,
            flatbuffers::Offset<flatbuffers::Vector<const MyGame::Sample::DefaultVertex*>> vertices = 0,
            int32_t indices_count = 0,
            flatbuffers::Offset<flatbuffers::Vector<uint32_t>> indices = 0,
            int32_t mesh_count = 0,
            flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<MyGame::Sample::Mesh>>> meshes = 0,
            int32_t bone_offset_count = 0,
            flatbuffers::Offset<flatbuffers::Vector<const MyGame::Sample::Mat4f*>> bone_offsets = 0,
            int32_t bone_to_name_count = 0,
            flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<MyGame::Sample::BoneToName>>> bone_to_names = 0,
            flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<MyGame::Sample::Node>>> nodes = 0) {
        ...
        inline flatbuffers::Offset<Model> CreateModelDirect(
            ...
            float bounding_sphere_radius = 0.0f,
            int32_t vertex_count = 0,
            const std::vector<MyGame::Sample::DefaultVertex>* vertices = nullptr,
            int32_t indices_count = 0,
            const std::vector<uint32_t>* indices = nullptr,
            int32_t mesh_count = 0,
            const std::vector<flatbuffers::Offset<MyGame::Sample::Mesh>>* meshes = nullptr,
            int32_t bone_offset_count = 0,
            const std::vector<MyGame::Sample::Mat4f>* bone_offsets = nullptr,
            int32_t bone_to_name_count = 0,
            const std::vector<flatbuffers::Offset<MyGame::Sample::BoneToName>>* bone_to_names = nullptr,
            const std::vector<flatbuffers::Offset<MyGame::Sample::Node>>* nodes = nullptr) {
            auto vertices__ = vertices ? _fbb.CreateVectorOfStructs<MyGame::Sample::DefaultVertex>(*vertices) : 0;
            auto indices__ = indices ? _fbb.CreateVector<uint32_t>(*indices) : 0;
            auto meshes__ = meshes ? _fbb.CreateVector<flatbuffers::Offset<MyGame::Sample::Mesh>>(*meshes) : 0;
            auto bone_offsets__ = bone_offsets ? _fbb.CreateVectorOfStructs<MyGame::Sample::Mat4f>(*bone_offsets) : 0;
            auto bone_to_names__ = bone_to_names ? _fbb.CreateVector<flatbuffers::Offset<MyGame::Sample::BoneToName>>(*bone_to_names) : 0;
            auto nodes__ = nodes ? _fbb.CreateVector<flatbuffers::Offset<MyGame::Sample::Node>>(*nodes) : 0;
            return MyGame::Sample::CreateModel(
                _fbb,
        ...
        inline const MyGame::Sample::Model* GetModel(const void* buf) {
            return flatbuffers::GetRoot<MyGame::Sample::Model>(buf);
        }

        inline const MyGame::Sample::Model* GetSizePrefixedModel(const void* buf) {
            return flatbuffers::GetSizePrefixedRoot<MyGame::Sample::Model>(buf);
        }
        ...
        inline bool VerifyModelBuffer(
            ...
            return verifier.VerifyBuffer<MyGame::Sample::Model>(ModelIdentifier());
        }

        inline bool VerifySizePrefixedModelBuffer(
            flatbuffers::Verifier& verifier) {
            return verifier.VerifySizePrefixedBuffer<MyGame::Sample::Model>(ModelIdentifier());
        }

        inline void FinishModelBuffer(
            flatbuffers::FlatBufferBuilder& fbb,
            flatbuffers::Offset<MyGame::Sample::Model> root) {
